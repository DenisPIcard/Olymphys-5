 ...
 */
final class Version20231110225000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE verou_classement (id INT AUTO_INCREMENT NOT NULL, centre_id INT DEFAULT NULL, etat TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_D2BC385E463CD7C3 (centre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE verou_classement ADD CONSTRAINT FK_D2BC385E463CD7C3 FOREIGN KEY (centre_id) REFERENCES centrescia (id)');
        ...
        $this->addSql('ALTER TABLE jures_cia CHANGE rapporteur rapporteur JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE notes ADD repquestions SMALLINT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE verou_classement DROP FOREIGN KEY FK_D2BC385E463CD7C3');
        $this->addSql('DROP TABLE verou_classement');
        ...
        $this->addSql('ALTER TABLE jures_cia CHANGE rapporteur rapporteur LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE notes DROP repquestions');
