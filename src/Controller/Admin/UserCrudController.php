...
class UserCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        if (Crud::PAGE_INDEX === $pageName) {
            ...
            return [$id, $username, $roles, $password, $email, $isActive, $token, $passwordRequestedAt, $uaiId, $nom, $prenom, $adresse, $ville, $code, $phone, $createdAt, $updatedAt, $lastVisit, $civilite, $autorisationphotos];
        } elseif (Crud::PAGE_NEW === $pageName) {
            return [$username, $email, $rolesedit, $password, $isActive, $nom, $prenom, $uaiId,  $adresse, $ville, $code, $phone];
        } elseif (Crud::PAGE_EDIT === $pageName) {
            return [$username, $email, $password, $rolesedit, $isActive, $nom, $prenom, $uaiId,  $adresse, $ville, $code, $phone];
        }
    }
