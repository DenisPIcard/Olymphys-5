...
class SelectionneesCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        $tableauExcel=Action::new('equipes_tableau_excel','Extraire un tableau Excel', 'fa fa_array')
            ->linkToRoute('equipes_tableau_excel')
            ->createAsGlobalAction();
        return $actions
    ...
    #[Route("/Admin/SelectionneesCrud/equipes_tableau_excel", name:"equipes_tableau_excel")]
    public function equipestableauexcel()
    {
        ...
        foreach ($liste_equipes as $equipe) {
            $sheet->setCellValue('A' . $ligne, $equipe->getEquipeinter()->getLettre())
                ...
                ->setCellValue('C' . $ligne, $equipe->getEquipeinter()->getRneId()->getNom())
                ->setCellValue('D' . $ligne, $equipe->getEquipeinter()->getRneId()->getCommune())
                ->setCellValue('E' . $ligne, $equipe->getEquipeinter()->getRneId()->getAcademie())
